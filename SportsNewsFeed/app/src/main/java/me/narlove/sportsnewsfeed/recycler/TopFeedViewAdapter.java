...
public class TopFeedViewAdapter extends ListAdapter<FeedItem, TopFeedViewAdapter.ViewHolder> {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        FeedItem item = TopFeedViewAdapter.this.getItem(position);
    ...
    public TopFeedViewAdapter(Context context, OnRecyclerViewItemClick listener) {
    ...
    @NonNull
    @Override
    public TopFeedViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.top_item_layout,
                viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull TopFeedViewAdapter.ViewHolder viewHolder, int position) {
